...
| requirement-least-privilege-user | LPU `dns-adm` F1–F7; dest Fence points at `requirement-incorrect-json-format`; L-M14 test-mode inbound; L-M15 login-hook-symlink points at independent hook REQ | architecture | Active (1.14.0) Implemented | `requirement-least-privilege-user.md` | 2026-09-08 |
| requirement-three-layer-privilege-model | Type 0/1/2 map + role table + Tables A/B/C; dest Fence points at independent REQ; P-M14 test-mode inbound; ELEV-CF-02 `dns-cli-hook` | architecture | Active (1.15.0) Type 1 + two-kind submitter + Type 2 switch Implemented | `requirement-three-layer-privilege-model.md` | 2026-09-03 |
...
| requirement-sudoer-json-file | Two JSON kinds + three dests (SJ-M4); grant path pin; `login-hook-elev` path `dns-cli-hook`; SJ-M6 test-mode inbound | architecture | Active (1.12.0) Implemented | `requirement-sudoer-json-file.md` | 2026-09-03 |
...
| requirement-login-interactive-hook | Independent login-hook plant; `/usr/local/bin/${APP_NAME}-hook`; `interactive` reviews `dns-adm` rc; skip names `login-hook-elev` | architecture | Active (1.1.0) Implemented | `requirement-login-interactive-hook.md` | 2026-09-08 |
