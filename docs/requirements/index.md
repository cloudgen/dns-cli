...
**Updated:** 2026-08-30 (storage = cache folder **and** persistency folder `${HOME}/.local/dns-cli`)
...
| requirement-least-privilege-user | LPU `dns-adm` F1–F7; dest Fence points at `requirement-incorrect-json-format`; L-M14 test-mode inbound | architecture | Active (1.12.0) Implemented | `requirement-least-privilege-user.md` | 2026-09-01 |
| requirement-three-layer-privilege-model | Type 0/1/2 map + role table + Tables A/B/C; dest Fence points at independent REQ; P-M14 test-mode inbound | architecture | Active (1.14.0) Type 1 + two-kind submitter + Type 2 switch Implemented | `requirement-three-layer-privilege-model.md` | 2026-09-01 |
...
| requirement-sudoer-json-file | Two JSON kinds + three dests (SJ-M4); grant path pin; SJ-M6 test-mode inbound | architecture | Active (1.11.0) Implemented | `requirement-sudoer-json-file.md` | 2026-09-01 |
