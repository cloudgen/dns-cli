...
| requirement-shell-cli-default-interaction | Case 3 numbered main menu on `menu`/`main`; header **`${APP_NAME}`**(*`${VERSION}`*) - `${SHORT_DESC}`; row explain light gray italic | shell | Active (1.1.0) Implemented | `requirement-shell-cli-default-interaction.md` | 2026-09-03 |
