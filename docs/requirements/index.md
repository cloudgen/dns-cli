...
**Updated:** 2026-09-08 (independent `requirement-login-interactive-hook`; `/usr/local/bin/${APP_NAME}-hook`)
...
| requirement-shell-cli-default-interaction | Case 3 numbered main menu: daily DNS work + family **sudoers** submenu; header **`${APP_NAME}`**(*`${VERSION}`*) - `${SHORT_DESC}`; row explain SGR 3;37 | shell | Active (1.3.0) Implemented | `requirement-shell-cli-default-interaction.md` | 2026-09-03 |
