...
| requirement-login-interactive-hook | Independent login-hook plant; soft link `/usr/local/bin/${APP_NAME}-hook`; heal of `dns-adm` rewrites old hook | architecture | Active (1.0.0) Implemented | `requirement-login-interactive-hook.md` | 2026-09-08 |
