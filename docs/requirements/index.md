...
| requirement-least-privilege-user | LPU `dns-adm` F1–F7; dest Fence points at `requirement-incorrect-json-format`; L-M14 test-mode inbound; L-M15 login-hook-symlink | architecture | Active (1.13.0) Implemented | `requirement-least-privilege-user.md` | 2026-09-03 |
...
| requirement-shell-cli-interface | Shell CLI interface; **dual mention** + **CI-M1a samples** on topic-owners; Type 0 **test-purpose** `test-json-format` / `fence-test`; **`menu`/`main`**; family `sudoers` not dispatched | shell | Active (3.10.0) | `requirement-shell-cli-interface.md` | 2026-09-03 |
