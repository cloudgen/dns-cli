...
**Updated:** 2026-09-03 (case 3 numbered main menu `menu`/`main`; header **dns-cli**(*version*) - short description; row explain light gray italic)
...
| requirement-shell-cli-interface | Shell CLI interface; **dual mention** + **CI-M1a samples** on topic-owners; Type 0 **test-purpose** `test-json-format` / `fence-test`; **`menu`/`main`** | shell | Active (3.8.0) | `requirement-shell-cli-interface.md` | 2026-09-03 |
| requirement-shell-cli-default-interaction | Case 3 numbered main menu on TTY empty argv and `menu`/`main`; header **`${APP_NAME}`**(*`${VERSION}`*) - `${SHORT_DESC}`; row explain SGR 3;37 | shell | Active (1.2.0) Implemented | `requirement-shell-cli-default-interaction.md` | 2026-09-03 |
