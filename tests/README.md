...
| `test_cli.sh` | CLI surface, Type N empty argv, offline reject, trimmed-verb reject, **dual mention**, actor-table split, dest fence catalog, **fence-test**, dest-owned `submit_app`, **cache + persistency folder** | **TP-CLI-*** (incl. **TP-CLI-17**) · **TP-CF-ACTOR-*** · **TP-FENCE-01..04** · **TP-FENCE-08..17** |
