...
| requirement-login-interactive-hook | architecture | TP-CF-APR-01..08 · **TP-LPU-08** | **have** — `.bashrc` / missing `.profile` heal; `/usr/local/bin/${APP_NAME}-hook`; old-hook rewrite on `dns-adm` |
