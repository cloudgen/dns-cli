...
| requirement-least-privilege-user | architecture | TP-LPU-01..08 · **TP-SUDOER-JSON-24** | **have** 01–08 (stub); **TP-LPU-03** Type 2 switch / `lpu_required`; **07** dest fence table; **L-M14** test-mode inbound; **08** `dns-review-hooks` alias |
...
| requirement-sudoer-json-file | architecture | TP-SUDOER-JSON-01..03,08..22 · **24** · TP-PRIV-05..08 | **have** — two JSON kinds + dest-owned queued allowlist + independent dest + role table + setup auto-submit + dest fence table + grant path pin + `login-hook-elev` `dns-review-hooks` + test-mode inbound skip |
| requirement-shell-cli-interface | shell | TP-CLI-* (incl. **TP-CLI-14** · **TP-CLI-15** · **TP-CLI-16** · **TP-CLI-18** · **TP-CLI-20** · **TP-CLI-21**) · **TP-FENCE-09..15** | Commands, flags, dispatch; dual mention; test-purpose `fence-test`; `menu`/`main`; family `sudoers` not dispatched |
| requirement-shell-cli-default-interaction | shell | **TP-CLI-18** · **TP-CLI-19** · **TP-CLI-20** · **TP-CLI-21** · TP-CLI-07 · TP-CLI-14 · TP-CLI-15 | Case 3 numbered menu; family sudoers submenu; invalid pick reprints the same layer; header `${APP_NAME}(${VERSION}) - ${SHORT_DESC}`; gray-italic explain |
...
**Honesty:** Type 0 TP-CLI / TP-LC (incl. **TP-CLI-14** dual mention · **TP-CLI-17** persistency folder · **TP-CLI-21** invalid menu pick reprints the same layer), v2 vault TP-CF-VAULT-01..33, **TP-AV-01..08**, TP-CF-MODE-01..08, TP-CF-APR-01..09, TP-LPU-01..08, TP-PRIV-01..10, TP-CF-ACTOR-01..09, TP-SUDOER-JSON-* (incl. **21**), **TP-CF-REQ-01..20**, **TP-ARSA-01/02**, **TP-FENCE-01..06**, **TP-FENCE-08**, and **TP-FENCE-09..17** are **have** against `src/dns-cli` **1.25.0**. **TP-FENCE-07** is **skip** (live sibling dest unknown-key; dest 1.8.1 still refuses `kind`).
