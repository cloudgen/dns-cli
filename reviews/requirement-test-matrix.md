...
| requirement-least-privilege-user | architecture | TP-LPU-01..07 · **TP-SUDOER-JSON-24** | **have** 01–07 (stub); **TP-LPU-03** Type 2 switch / `lpu_required`; **07** dest fence table; **L-M14** test-mode inbound |
...
| requirement-sudoer-json-file | architecture | TP-SUDOER-JSON-01..03,08..22 · **24** · TP-PRIV-05..08 | **have** — two JSON kinds + dest-owned queued allowlist + independent dest + role table + setup auto-submit + dest fence table + grant path pin + test-mode inbound skip |
