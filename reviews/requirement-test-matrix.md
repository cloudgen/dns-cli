...
| requirement-least-privilege-user | architecture | TP-LPU-01..06 | **have** 01–06 (stub); **TP-LPU-03** Type 2 switch / `lpu_required` |
| requirement-three-layer-privilege-model | architecture | TP-PRIV-01..09 | **have** — print-sudoers / setup / generate+submit / role table |
| requirement-sudoer-json-file | architecture | TP-SUDOER-JSON-01..03,08..15 · TP-PRIV-05..08 | **have** — two JSON kinds + independent dest + role table + setup auto-submit |
...
| requirement-application-local-vault | shell | TP-AV-01..07 have | specify + default LPU-home vaults child + `lpu_missing` |
...
**Honesty:** Type 0 TP-CLI / TP-LC (incl. **TP-CLI-14** dual mention), v2 vault TP-CF-VAULT-01..33, TP-AV-01..07, TP-CF-MODE-01..08, TP-CF-APR-01..06, TP-LPU-01..06, TP-PRIV-01..09, TP-CF-ACTOR-01..07, TP-SUDOER-JSON-*, and **TP-CF-REQ-01..08** are **have** against `src/dns-cli` **1.9.0**.
